		...
		<mdb-row>
			<mdb-col sm="4">
				<mdb-card wide>
					<mdb-view hover cascade>
						<a href="#!">
							<mdb-card-image src="https://imgctcf.aeplcdn.com/thumbs/p-nc-a-ver5/images/car-data/big/bmw-x7-default.jpg" alt="Card image cap" ></mdb-card-image>
			...
			<mdb-col sm="4">
				<mdb-card narrow>
					<mdb-view hover cascade>
						<a href="#!">
							<mdb-card-image src="https://static.compareindia.news18.com/compareindia/gallery/images/2011/jun/swift_wb_350x263.jpg" alt="Card image cap"></mdb-card-image>
							<mdb-mask flex-center waves overlay="white-slight"></mdb-mask>
						</a>
					</mdb-view>
			...
			<mdb-col sm="4">
				<mdb-card cascade>
					<mdb-view hover cascade>
						<a href="#!">
							<mdb-card-image src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQC7LWg0CsCD3lnsMvbzlAgh-n7nWjUb1jzVPk2_qpsf9d7o2pC&s" alt="Card image cap"></mdb-card-image>
							<mdb-mask flex-center waves overlay="white-slight"></mdb-mask>
						</a>
					</mdb-view>
					<mdb-card-body class="text-center" cascade>
