		...
		<mdb-row>
			<mdb-col sm="4">
				<mdb-card wide>
					<mdb-view hover cascade>
						<a href="#!">
							<mdb-card-image src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRw9iukaLnoGG1WuMO6AQGcIMY9SXnRdWOl96YC_-aCryH7jmzR&s" alt="Card image cap" ></mdb-card-image>
			...
			<mdb-col sm="4">
				<mdb-card narrow>
					<mdb-view hover cascade>
						<a href="#!">
							<mdb-card-image src="http://motortrade.com.ph/wp-content/uploads/2019/07/sniper-150-doxou-1024x679.jpg" alt="Card image cap"></mdb-card-image>
							<mdb-mask flex-center waves overlay="white-slight"></mdb-mask>
						</a>
					</mdb-view>
					<mdb-card-body cascade>
						...
						<mdb-btn color="success">Button</mdb-btn>
					</mdb-card-body>
				</mdb-card>
			</mdb-col>
			<mdb-col sm="4">
				<mdb-card cascade>
					<mdb-view hover cascade>
						<a href="#!">
							<mdb-card-image src="https://images-na.ssl-images-amazon.com/images/I/81lUNopdNgL._SX466_.jpg" alt="Card image cap"></mdb-card-image>
							<mdb-mask flex-center waves overlay="white-slight"></mdb-mask>
						</a>
					</mdb-view>
					<mdb-card-body class="text-center" cascade>
